/*
    ...
    NOTES:  
    0. std::priority_queue is a container adapter that provides constant time lookup of the largest OR smallest element.
    1. By default std::vector is the container used inside. vector is used to make a tree, min heap or max heap
    2. Cost of insertion and extration is logarithmic.
